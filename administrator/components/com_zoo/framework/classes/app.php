 ...
 * @since 1.0.0
 *
 * @property AliasHelper       $alias
 * @property ApplicationHelper $application
 * @property ErrorHelper       $error
 * @property EventHelper       $event
 * @property HTMLHelper        $html
 * @property SystemHelper      $system
 * @property RequestHelper     $request
 * @property RouteHelper       $route
 * @property UserAppHelper     $user
 * @property TableHelper       $table
 * @property TemplateHelper    $template
