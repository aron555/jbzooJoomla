    ...
    public function save($file) {
		...
		if ($this->img_format) {
			...
			if ($this->thumb_resize) {
				...
				$src = imagecreatetruecolor((int) $width, (int)$height);
				...
				if (function_exists('imagecopyresampled')) {
					@imagecopyresampled($src, $this->img_source, 0, 0, 0, 0, (int) $width, (int) $height, $this->img_width, $this->img_height);
				} else {
					@imagecopyresized($src, $this->img_source, 0, 0, 0, 0, (int) $width, (int) $height, $this->img_width, $this->img_height);
				}
			...
			$thumbnail = imagecreatetruecolor((int) $this->thumb_width, (int) $this->thumb_height);
			...
			@imagecopy($thumbnail, $src, 0, 0, $src_x, $src_y, (int) $this->thumb_width, (int) $this->thumb_height);
