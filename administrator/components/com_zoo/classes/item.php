...
class Item {
    ...
    /**
     * The item is shown on frontpage
     *
     * @var bool
     * @since 2.0
     */
    ...
    public function canEdit($user = null) {
        return $this->app->user->canEdit($user, $this->getAssetName(), $this->created_by);
    }
    ...
    /**
     * Returns asset name of the item's type
     *
    ...
    public function getAssetName() {
        return strtolower(preg_replace('#[\s\-]+#', '.', trim("com_zoo.application.{$this->getApplication()->id}.{$this->type}")));
    }
