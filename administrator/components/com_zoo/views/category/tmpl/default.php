...
<div class="box-bottom">
				...
				<thead>
					<tr>
						...
						<th class="name">
							...
							<span class="small">
								<span class="collapse-all"><?php echo Text::_('Collapse All'); ?></span> / <span class="expand-all"><?php echo Text::_('Expand All'); ?></span>
							</span>
						</th>
						<th class="items">
	...
	<?php else:
			...
			$title   = Text::_('NO_CATEGORIES_YET').'!';
			$message = Text::_('CATEGORY_MANAGER_DESCRIPTION');
...
<script type="text/javascript">
	jQuery(function($) {
		...
		$('#toolbar-refresh a, #toolbar-refresh button').each(function() {
		    ...
		    //  if (!confirm('<?php //echo Text::_('CATEGORY_REORDER_PROMPT') ?>//')) {
		    //    return false;
		    //  };
            //
...
class CategoryRenderer {
	...
	public function  __construct($app, $application) {
		$this->_texts['edit_category']	= Text::_('Edit Category');
		$this->_texts['published']		= Text::_('Published');
		$this->_texts['unpublished']	= Text::_('Unpublished');
		$this->_texts['publish_item']	= Text::_('Publish item');
		$this->_texts['unpublish_item'] = Text::_('Unpublish Item');
