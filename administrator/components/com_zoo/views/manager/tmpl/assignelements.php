...
<div class="box-bottom">
	...
	<div class="col col-left width-50">
		...
		<fieldset>
		<legend><?php echo Text::_('Positions'); ?></legend>
			...
			<?php
				...
				if (isset($this->positions['positions']) && ($positions = $this->positions['positions']) && count($positions)) {
					...
					echo '<i>'.Text::_('No positions defined').'</i>';
				}
			?>
	...
	<div class="col col-right width-50">
		...
		<fieldset>
		<legend><?php echo Text::_('Core'); ?></legend>
		...
		<fieldset>
		<legend><?php echo Text::_('Custom'); ?></legend>

		<?php
			$elements = $this->type->getElements();
			if ($elements === false || count($elements) == 0) {
				echo '<i>'.Text::_('No custom elements defined for this type').'</i>';
			}
