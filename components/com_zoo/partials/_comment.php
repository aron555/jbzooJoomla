...
<li>
	<div id="comment-<?php echo $comment->id; ?>" class="comment <?php if ($author->isJoomlaAdmin()) echo 'comment-byadmin'; ?>">
		...
		<div class="comment-head">
			...
			<?php if ($author->url) : ?>
				<h3 class="author"><a href="<?php echo Route::_($author->url); ?>" title="<?php echo $author->url; ?>" rel="nofollow"><?php echo $author->name; ?></a></h3>
			<?php else: ?>
		...
		<div class="comment-body">
			...
			<?php if ($comment->state != Comment::STATE_APPROVED) : ?>
				<div class="moderation"><?php echo Text::_('COMMENT_AWAITING_MODERATION'); ?></div>
			<?php endif; ?>
