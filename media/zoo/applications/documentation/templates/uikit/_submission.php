...
<form id="item-submission" class="uk-form" action="<?php echo Route::_($this->app->route->submission($this->submission, $this->type->id, null, $this->item->id, $this->redirectTo)); ?>" method="post" name="submissionForm" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="uk-alert"><?php echo Text::_('REQUIRED_INFO'); ?></div>

	<div class="uk-margin">
		<button type="submit" id="submit-button" class="uk-button"><?php echo $this->item->id ? Text::_('Save') : Text::_('Submit Item'); ?></button>
		<?php if ($this->cancelUrl) : ?>
			<a href="<?php echo Route::_($this->cancelUrl); ?>" id="cancel-button" class="uk-button uk-button-link"><?php echo Text::_('Cancel'); ?></a>
		<?php endif; ?>
	</div>
