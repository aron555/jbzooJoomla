...
<div id="<?php echo $this->identifier; ?>" class="select-relateditems">
	...
	<?php foreach ($data as $item) : ?>
		...
		<li>
			<div>
				...
				<div class="item-sort" title="<?php echo Text::_('Sort Item'); ?>"><span class="uk-icon" uk-icon="icon: triangle-down"></span></div>
				<div class="item-delete" title="<?php echo Text::_('Delete Item'); ?>"><span class="uk-icon" uk-icon="icon: trash"></span></div>
	...
	<a class="item-add uk-button uk-button-default modal-button" rel="{handler: 'iframe', size: {x: 850, y: 500}}" title="<?php echo Text::_('Add Item'); ?>" href="<?php echo $link; ?>" ><?php echo Text::_('Add Item'); ?></a>
</div>
