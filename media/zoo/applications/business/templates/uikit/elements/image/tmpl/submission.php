...
<div class="uk-clearfix <?php echo $this->identifier; ?>">
		...
		<div class="zo-upload">
			...
			<div class="zo-button-container">
				<button class="uk-button search" type="button"><?php echo Text::_('Search'); ?></button>
		...
		<?php if (isset($lists['image_select'])) : ?>
			...
			<?php echo $lists['image_select']; ?><span class="uk-form-help-inline"><?php echo Text::_('ALREADY UPLOADED'); ?></span>
	...
	<div class="uk-margin image-preview">
		...
		<span class="image-cancel" title="<?php Text::_('Remove image'); ?>"><i class="uk-icon-times"></i></span>
	</div>
	...
	<div class="more-options">
		...
		<div class="trigger zo-absolute">
			<div class="uk-button-group">
				<div class="link button uk-button uk-button-mini"><?php echo Text::_('Link'); ?></div>
				<div class="title button uk-button uk-button-mini"><?php echo Text::_('Title'); ?></div>
			</div>
		</div>
