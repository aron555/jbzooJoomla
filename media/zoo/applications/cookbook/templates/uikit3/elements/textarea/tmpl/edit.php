...
<div id="<?php echo $this->identifier; ?>" class="repeat-elements">
	...
	<p class="add">
		<a href="javascript:void(0);"><span class="uk-icon" uk-icon="icon: plus"></span> <?php echo Text::sprintf('Add another %s', Text::_($this->app->string->ucfirst($this->getElementType()))) ?></a>
	</p>
</div>
